...
These modules form one cohesive package and cross-import only through the composition
root. Add package-boundary enforcement when a second owned package or stable external
Python API creates a meaningful boundary.
